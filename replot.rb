...
opts = Trollop::options do
  ...
  opt :solution, "The solution filename", :type => :string
...
Trollop::die :solution, "must exist" if(opts[:solution].nil? || File.exist?(opts[:solution])==false)
...
opt.reload_data(Objective::FCFS,opts[:solution])
